...
public class DemoService {
        ...
        public DemoAppResponse createDemoAppKey() {
                /**
                 * Generates temporary demo app key with sample rules for testing.
                 * Demo app auto-expires after configured TTL (default: 15 minutes).
                 * Cached only - no persistence to database.
                 */
