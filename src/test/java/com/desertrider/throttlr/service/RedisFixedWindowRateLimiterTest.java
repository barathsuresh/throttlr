...
import com.desertrider.throttlr.service.limiter.RedisFixedWindowRateLimiter;
...
class RedisFixedWindowRateLimiterTest {
    ...
    void checkMapsRedisScriptResultToCheckResponse() {
        ...
        RedisFixedWindowRateLimiter limiter = new RedisFixedWindowRateLimiter(redisTemplate);
        ...
        assertEquals(List.of("rl:app-1:user:123"), redisTemplate.keys);
